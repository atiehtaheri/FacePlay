...
const std::string thresholds_filename = "CRDefaults.txt";
...
{
	wxStaticText *txt = new wxStaticText(panel, -1, wxT("Key 1"));
	txt->SetForegroundColour("#F6F7DD");
	wxFont font = txt->GetFont();
	font.SetPointSize(12);
	font.SetFamily(wxMODERN);
	...
	ComboBox1 = new wxComboBox(panel, CB1_ID, m_arrItems[size_t(tracking_modes[0])],
		wxDefaultPosition, wxDefaultSize, m_arrItems, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
